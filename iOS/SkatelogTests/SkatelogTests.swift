import XCTest
@testable import Skatelog

@MainActor
final class SkatelogTests: XCTestCase {
    ...
    func testAddEntry() {
        ...
        store.add(trick: "Ollie", value1: 10, value2: 5)
    ...
    func testAddRespectsFreeLimit() {
        ...
        for i in 0..<Store.freeLimit {
            store.add(trick: "Ollie", value1: i, value2: 1)
        }
        let result = store.add(trick: "Ollie", value1: 1, value2: 1)
    ...
    func testDeleteEntry() {
        let store = Store()
        store.entries = []
        store.add(trick: "Ollie", value1: 1, value2: 1)
    ...
    func testDeleteAtOffsets() {
        ...
        store.entries = []
        store.add(trick: "Ollie", value1: 1, value2: 1)
        store.add(trick: "Ollie", value1: 2, value2: 2)
