...
/// Skatelog's own identity: a palette built specifically for this app's
/// domain, not a shared portfolio default.
enum AppTheme {
    static let backdrop = Color(red: 0.06, green: 0.06, blue: 0.07)
    static let card = Color.white
    static let cardBorder = Color(red: 1.0, green: 0.8, blue: 0.1).opacity(0.18)

    static let ink = Color(red: 0.12, green: 0.12, blue: 0.14)
    static let inkFaded = Color(red: 0.12, green: 0.12, blue: 0.14).opacity(0.56)

    static let accent = Color(red: 1.0, green: 0.8, blue: 0.1)
    static let accentDeep = Color(red: 1.0, green: 0.8, blue: 0.1).opacity(0.75)
